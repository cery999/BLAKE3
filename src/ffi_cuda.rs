...
pub unsafe fn compress_in_place(
    ...
    ffi::blake3_compress_in_place_cuda(cv.as_mut_ptr(), block.as_ptr(), block_len, counter, flags)
}
...
pub mod ffi {
    ...
    extern "C" {
        ...
        pub fn blake3_compress_xof_cuda(
            cv: *const u32,
            block: *const u8,
            block_len: u8,
            counter: u64,
...
mod test {
    ...
    #[test]
    fn test_compress() {
        if !crate::platform::cuda_detected() {
            return;
        }
